...
namespace JodyCore2.Test.Xunit.Data.Equality
{
    public class StandingsEqualityTests
    {
        public static IEnumerable<object[]> GetDataForStandingsTest()
        {
            ...
            {
                "Equal Scenario",
                new Standings(guid1, "My Name", 1, 2, 1, "No Descr", "No Div", null, null, false, false, false, false),
                new Standings(guid1, "My Name", 1, 2, 1, "No Descr", "No Div", null, null, false, false, false, false),
                true
            };
            yield return new object[]
            {
                "Guid",
                new Standings(guid1, "My Name", 1, 2, 1, "No Descr", "No Div", null, null, false, false, false, false),
                new Standings(guid2, "My Name", 1, 2, 1, "No Descr", "No Div", null, null, false, false, false, false),
                false
            };
            yield return new object[]
            {
                "Name",
                new Standings(guid1, "My2 Name", 1, 2, 1, "No Descr", "No Div", null, null, false, false, false, false),
                new Standings(guid1, "My Name", 1, 2, 1, "No Descr", "No Div", null, null, false, false, false, false),
                false
            };           
